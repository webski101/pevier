    ...
    <main className="public-home">
      ...
      <section className="public-hero">
        <div className="public-hero__copy">
          ...
          <p className="public-hero__lede">Pevier evaluates every autonomous publication request, blocks unsafe actions, publishes approved Reels for Instagram Business or Creator accounts and text posts for Bluesky, and preserves verifiable audit evidence.</p>
        ...
        <div className="public-adapters">
          <div className="public-gateway" aria-label="Pevier publishing enforcement flow">
            ...
            <div><Cloud size={19} /><span>Social adapters<small>Instagram Business/Creator + Bluesky</small></span></div>
