...
export default function TermsPage() {
  return (
    <LegalPage eyebrow="SERVICE AGREEMENT" title="Terms of Service" updated="16 August 2026">
      ...
      <section><h2>Platform rules</h2><p>Your use of Instagram and Bluesky remains subject to the applicable platform and AT Protocol provider terms and policies. Platform availability, quotas, reviews, and enforcement are controlled by those providers and may change independently of Pevier.</p></section>
