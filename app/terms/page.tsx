...
export default function TermsPage() {
  return (
    <LegalPage eyebrow="SERVICE AGREEMENT" title="Terms of Service" updated="15 August 2026">
      ...
      <section><h2>Platform rules</h2><p>Your use of Instagram remains subject to Meta&apos;s and Instagram&apos;s terms and policies. Platform availability, quotas, reviews, and enforcement are controlled by Meta and may change independently of Pevier.</p></section>
