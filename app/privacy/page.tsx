...
export const metadata: Metadata = {
  ...
  description: "How Pevier handles account, Instagram, policy, and audit data.",
};
...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="DATA PRACTICES" title="Privacy Policy" updated="15 August 2026">
      ...
      <section><h2>Information we collect</h2><p>When you sign in with Google, Pevier receives your verified email address, name, profile image, and Google account identifier. We request only basic identity scopes and do not request YouTube access. When you later connect Instagram, Pevier receives your Professional account identifier, username, account type, OAuth credentials, and the content you explicitly submit for evaluation or publishing.</p></section>
      ...
      <section><h2>Your choices</h2><p>You can decline Instagram permissions, disconnect Instagram in Pevier, or stop using the service at any time. Disconnecting prevents future Instagram actions but does not automatically remove audit evidence already stored for security and integrity purposes.</p></section>
