...
export function ControlRoom() {
  ...
  return <div className="app-shell">
    ...
    </main><footer className="foot-line"><span>PEVIER / LOCAL CONTROL PLANE</span><span>Policy set v1.4 · SHA-256 evidence · {youtubeStatus?.connected && youtubeStatus.mode === "LIVE" ? "YOUTUBE PRIVATE" : "DRY RUN"}</span><span>Operator responsibility applies</span></footer></div>
